    ...
    return (
      <div className="pt-8 px-5 mb-25 bg-linear-to-r from-[#111111] to-[#777777]">
        <div className="page-size  lg:flex justify-between items-center ">
          <div className="">
            <h1 className="text-white font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-7">
              Get body in <br /> shape & stay <br /> healthy
            </h1>
            <p className="mb-7">
              A huge selection of health and <br className="sm:hidden" />{" "}
              fitness content, healthy recipes <br /> and transformation stories
              to help <br className="sm:hidden" /> you get fit and stay fit!
            </p>
          ...
          <div className="relative ">
            ...
            "
              ></div>
              <div className="">
                <h1 className="text-[#FAFAF9] mb-2 font-black text-2xl">
                  350+
                </h1>
                <p className="text-[#EFEDE8]/64">Video tutorial</p>
              </div>
            </div>
            <div className="absolute top-12 -right-1 lg:-right-19 lg:top-32 sm:right-50 bg-[#FFFFFF]/10 px-2 lg:px-6 py-2  rounded-xl">
              <div className="">
